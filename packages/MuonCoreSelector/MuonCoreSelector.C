...
void MuonCoreSelector::InsideLoop() {
...
//---------------------------------------------------------------------------------------------------------------------
void MuonCoreSelector::CheckMuons() {
...
//---------------------------------------------------------------------------------------------------------------------
bool MuonCoreSelector::passMediumID(int iMu) {
...
//---------------------------------------------------------------------------------------------------------------------
bool MuonCoreSelector::passISO(int iMu, string typeIso, float wp) {
...
//---------------------------------------------------------------------------------------------------------------------
float MuonCoreSelector::getISO(int iMu, string typeIso) {
...
// --------------------------------------------------------------------------------------------------------------------
void MuonCoreSelector::SetGenInfo() {
...
//---------------------------------------------------------------------------------------------------------------------
void MuonCoreSelector::GetMatching() {
...
//---------------------------------------------------------------------------------------------------------------------
void MuonCoreSelector::SetEventFlags() {
...
//           the Summary method
//---------------------------------------------------------------------------------------------------------------------
void MuonCoreSelector::Counting() {
